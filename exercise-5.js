...
function totalDigitRekursif(angka) {
    var angkanya = String(angka);
    
    if(angkanya.length === 1){
      return Number(angkanya);
    } else {
      // console.log(angkanya);
      var angkaTerkini = angkanya.slice(0, 1);
      // console.log(angka);
      angka = angkanya.slice(1);
      // console.log(deretTerkini);
      
      return Number(angkaTerkini) + totalDigitRekursif(angka);
    }
  }
